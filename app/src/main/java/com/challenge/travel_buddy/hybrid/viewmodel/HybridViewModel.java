...
public class HybridViewModel extends AndroidViewModel {
...
//    public ObservableField<> project = new ObservableField<>();
    ...
    @Inject
    public HybridViewModel(@NonNull BusPointRepository busPointRepository, @NonNull Application application) {
        super(application);
        this.busPointRepository = busPointRepository;
    }
    public LiveData<List<BusModel>> getBusPoint(String val){
        return searchStationModelLiveData;
    }
    public void searchBusPoint(String val){
